...
const SearchBar = () => {
  return (
    <div className='flex items-center gap-[32px] mb-[48px]'>
      ...
      <button className='w-[200px] justify-center text-[18px] flex items-center gap-[10px] text-white cursor-pointer bg-[#32302F] hover:bg-[#000000] px-[14px] py-[10px] rounded-[10px] max-lg:text-[16px]'>
        Add Prizes
